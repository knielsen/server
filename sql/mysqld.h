...
extern double opt_snc_replication_trx_slow_commit_double;
extern ulonglong opt_snc_replication_trx_slow_commit_usec;
...
enum options_mysqld
{
  ...
  OPT_BINLOG_ROW_DO_TABLE,
  OPT_BINLOG_ROW_IGNORE_TABLE,
  OPT_BIN_LOG,
  OPT_BOOTSTRAP,
  OPT_CONSOLE,
